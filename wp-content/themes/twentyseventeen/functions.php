...
$m_args = array(
    'label' => 'ミドルバナー',//投稿タイプの名前
    'labels' => array(
        'singular_name' => 'ミドルバナー',//投稿タイプの名前
        'menu_name' => 'ミドルバナー',//メニュー（画面の左）に表示するラベル
        'add_new_item' => '新規投稿を追加',//新規作成ページの左上に表示されるタイトル
        'add_new' => '新規追加',//メニュー（画面の左）の「新規」の位置に表示するラベル
        'new_item' => '新規投稿',//一覧ページの右上にある新規作成ボタンのラベル
        'edit_item'=>'投稿を編集',//編集ページの左上にあるタイトル
...
register_post_type("middle-banner",$m_args);
$b_args = array(
    'label' => 'フッター上バナー',//投稿タイプの名前
    'labels' => array(
        'singular_name' => 'フッター上バナー',//投稿タイプの名前
        'menu_name' => 'フッター上バナー',//メニュー（画面の左）に表示するラベル
        'add_new_item' => '新規投稿を追加',//新規作成ページの左上に表示されるタイトル
        'add_new' => '新規追加',//メニュー（画面の左）の「新規」の位置に表示するラベル
        'new_item' => '新規投稿',//一覧ページの右上にある新規作成ボタンのラベル
        'edit_item'=>'投稿を編集',//編集ページの左上にあるタイトル
...
register_post_type("bottom-banner",$b_args);
$r_args = array(
    'label' => 'サイドバナー',//投稿タイプの名前
    'labels' => array(
        'singular_name' => 'サイドバナー',//投稿タイプの名前
        'menu_name' => 'サイドバナー',//メニュー（画面の左）に表示するラベル
        'add_new_item' => '新規投稿を追加',//新規作成ページの左上に表示されるタイトル
        'add_new' => '新規追加',//メニュー（画面の左）の「新規」の位置に表示するラベル
        'new_item' => '新規投稿',//一覧ページの右上にある新規作成ボタンのラベル
        'edit_item'=>'投稿を編集',//編集ページの左上にあるタイトル
...
register_post_type("right-banner",$r_args);